...
As you can see it works really well on the spanish example but not so good on the greenwich one. This comes from the annoying pronounciation hints at the end of the english vocabulary and the coloring. For that reason give good images to the process. Note that you will always need to open the csv file in some spreadsheet editor to fix stuff like the '1A' in the spanish example but for good scans it works really good.

## Webinterface (recommended)
